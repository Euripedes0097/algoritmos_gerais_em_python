...
#Caso não seja um quadrado perfeito, a sua raiz quadrada inteira 'r' será suficiente para o intervalo [2, r] pertencente ao
#conjunto dos naturais calcular a existência de algum divisor.

import math

primos = [2]

intervalo = list(range(3,100,2)) #ímpares de [3, 100)
